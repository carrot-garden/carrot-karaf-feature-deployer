 ...
 */
public class FeatureURLHandlerXXX extends AbstractURLStreamHandlerService {

    private final Logger logger = LoggerFactory.getLogger(FeatureURLHandlerXXX.class);
    ...
    public class Connection extends URLConnection {
        ...
        public InputStream getInputStream() throws IOException {
            try {
                ...
                FeatureTransformerXXX.transform(featureXmlURL, os);
                os.close();
